...
export const DeleteModal = ({ isOpen, onClose, onConfirm, isDeleting, noteTitle }: DeleteModalProps) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4">
      ...
      <div className="glass-strong rounded-2xl p-8 w-full max-w-md relative z-10 shadow-2xl">
